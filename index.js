...
var state;
var startingBlock = ENV.STARTINGBLOCK || 42792723; //GENESIS BLOCK
const username = ENV.ACCOUNT || 'hashkings'; //account with all the SP
const key = steem.PrivateKey.from(ENV.KEY); //active key for account
const sh = ENV.sh || '';
const ago = ENV.ago || 42792723;
...
processor.on('market_post_seed', function(json, from) {
    ...
    let price = json.price,
        ...
        state.users[from].seeds[postedSeed[0]].forSale = true;
        console.log(state.users[from].seeds.postedSeed[0])
